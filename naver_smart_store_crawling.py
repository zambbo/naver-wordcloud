...
# 이 정보를 빼오는 방법을 몰라서 하나하나 수기로 일단 작성(proto) 차례대로 보석십자수(라임나무),보석십자수(하루클래스),아두이노키트(메카솔루션)
ProductNo_list = ['4266112558','5153958110','2851993975']
merchantNo_list = ['500105879','510830988','510126385']
