...
class Category:
    def __init__(self, _categoryList):
        self.categoryList = _categoryList

    
    def saveCategoryCSVFromBlogger_csv(self, _file_name):
        ...
        for category_ in self.categoryList:
        ...
        for category,category_dataframe_ in zip(self.categoryList,category_dataframe_list):
    ...
    def getCategoryFromBlogger_tuple(self, _blogger_posts):
        nick_item_dict = dict()
